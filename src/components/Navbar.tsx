  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        >
          <div className="w-10 h-10 bg-accent flex items-center justify-center rounded-lg group-hover:rotate-12 transition-transform">
            <span className="text-bg font-black">AM</span>
          </div>
          <span className="hidden sm:block">Arpit Mehra</span>
        </motion.a>
      ...
      {isOpen && (
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          className="absolute top-full left-0 right-0 bg-bg border-b border-white/10 p-6 flex flex-col gap-4 md:hidden"
        >
          {navLinks.map((link) => (
            <a
              key={link.name}
